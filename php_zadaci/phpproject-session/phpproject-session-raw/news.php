...
if (!isset($action)) {
	...
	if ($action == 1) {
		...
		$_SESSION['news_title_1'] = "US growth faster than expected";  # Spremanje u sjednicu
		print '
		...
		# inicijalizacija sjednice
		$_SESSION['news_title_2'] = "Wall Street: Tech firm surge pushes US markets higher";  # Spremanje u sjednicu
		print '
		...
		# inicijalizacija sjednice
		$_SESSION['news_title_3'] = "Hotel booking sites probed by consumer watchdog";  # Spremanje u sjednicu
		print '
