...
if (!empty($_COOKIE['news_title_1']) || !empty($_COOKIE['news_title_2']) || !empty($_COOKIE['news_title_3'])) {
	print '
			<aside><h2 style="text-align:center">Zadnje pregledane vijesti</h2>
			<ul>';

	if (!empty($_COOKIE['news_title_1'])) {
		print '<li>' . htmlspecialchars($_COOKIE['news_title_1']) . '</li>';
	}
	if (!empty($_COOKIE['news_title_2'])) {
		print '<li>' . htmlspecialchars($_COOKIE['news_title_2']) . '</li>';
	}
	if (!empty($_COOKIE['news_title_3'])) {
		print '<li>' . htmlspecialchars($_COOKIE['news_title_3']) . '</li>';
	}
